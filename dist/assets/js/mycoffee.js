(function() {
  $(function() {
    ...
    /* footer display time */
    var $footer, $myCircle, $myDefault, $myGeometry, $mySquare, $myTree, centerX, centerY, ctxCircle, ctxDefault, ctxGeometry, ctxSquare, ctxTree, radius;
    $footer = $('.footer');
    setInterval(function() {
      var nowDate;
      nowDate = new Date();
      return $footer.text(nowDate);
    }, 1000);
    ...
    /*
      ...
      show graphs
     */
    return $('.aside ul li').click(function() {
      var N;
      N = $(this).index() + 1;
      return $('.section .article').find('canvas').css('display', 'none').eq(N).css('display', 'inline-block');
    });
  });
